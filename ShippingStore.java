        ...
        for (int i = 0; i < users.size(); i++){
                if (users.get(i).getID() == custID){
                    ...
                    for (int b = 0; b < packages.size(); b++) {
                        ...
                        else if (b==packages.size()-1 && !packageNumber.equals(packageObject.getTN())){
                    ...
                    for (int j = 0; j < users.size(); j++){
                        ...
                        if (userObject2.getID() == employID){
                            System.out.println("Employee Found! Added to Transactions!");
                             ...
                             //serialization of transactions array list                            
                             try {         
...
public void changeUser(int ID){
    ...
    public void flush(){
        ...
        System.out.println("Files have been deserialized!\n");
        System.out.println("This is the information that was saved from the packages list: ");
        for (int i=0; i < packages.size(); i++){
            System.out.println(packages.get(i).getTN() + ", " + packages.get(i).getMC() + ", " + ", " + packages.get(i).getSpec());
            System.out.println("\n");
        }
        
        System.out.println("This is information that was saved from the users list: \n");
        for (int i=0; i < users.size(); i++){
            System.out.println(users.get(i).getID() + ", " + users.get(i).getFN() + ", " + users.get(i).getLN());
            System.out.println("\n");
        }
        
        System.out.println("This is the information that was saved from the transactions list: ");
        for (int i=0; i < trans.size(); i++){
            System.out.println(trans.get(i).getCID() + ", " + trans.get(i).getTN() + ", " + trans.get(i).getShipD() + ", " + trans.get(i).getDelivD() + ", " + trans.get(i).getCost());
        }
}
